...
def parse_args() -> argparse.Namespace:
    ...
    p.add_argument('--AC_critic', default = 'V', type=str, choices = ['Q', 'V'], help="Whether critic estimates Q(s,a) or V(s)")
...
def main() -> None:
    if args.WandDB:
        run_name = f"AC_{args.domain}_g{args.gamma}_lrp{args.lr_policy}_lrc{args.lr_critic}_h{args.hidden}_func_{args.AC_critic}"
    
        wandb.init(
            project="Actor-Critic RL",
            config={
                "domain": args.domain,
